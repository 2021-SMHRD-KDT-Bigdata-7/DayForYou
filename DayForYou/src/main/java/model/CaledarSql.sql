...
insert into tbl_todo values (TBL_TODO_SEQ.nextval,'ss','공부', '2021-12-09', '2021-12-14',null,sysdate,'a','y');
...
INSERT INTO tbl_todo (todo_seq, todo_title, todo_cate, todo_sdate, todo_edate, reg_date, m_id, todo_allday)
VALUES (TBL_TODO_SEQ.nextVal, '프로젝트', '공부', '2021-12-07', '2021-12-12', sysdate, 'admin', 'Y');

INSERT INTO tbl_todo (todo_seq, todo_title, todo_cate, todo_sdate, todo_edate, reg_date, m_id, todo_allday) 
VALUES (TBL_TODO_SEQ.nextVal, '프로젝트', '공부', '2021-12-13', '2021-12-19', sysdate, 'admin', 'Y');

INSERT INTO tbl_todo (todo_seq, todo_title, todo_cate, todo_sdate, todo_edate, reg_date, m_id, todo_allday) 
VALUES (TBL_TODO_SEQ.nextVal, '프로젝트', '공부', '2021-12-20', '2021-12-21', sysdate, 'admin', 'Y');
...
INSERT INTO tbl_todo (todo_seq, todo_title, todo_cate, todo_sdate, todo_edate, reg_date, m_id, todo_allday)
VALUES (TBL_TODO_SEQ.nextVal, '카드값 결제', '기타', '2021-12-10', '2021-12-10', sysdate, 'admin', 'Y');
