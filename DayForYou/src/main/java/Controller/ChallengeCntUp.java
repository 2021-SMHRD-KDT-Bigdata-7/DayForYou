...
/**
 * Servlet implementation class ChallengeCntUp
 */
@WebServlet("/ChallengeCntUp")
public class ChallengeCntUp extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		challengeBoardVO zvo = dao.ChallengeCntUp(chal_seq);
