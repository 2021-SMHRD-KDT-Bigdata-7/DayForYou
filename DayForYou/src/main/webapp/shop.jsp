...
<html lang="en">
    ...
    <body>
        ...
        <a class="btn btn-outline-dark mt-auto">치킨</a>
        <a class="btn btn-outline-dark mt-auto">영화</a>
        <a class="btn btn-outline-dark mt-auto">상품권</a>
        <br>
        
        <a class="btn btn-outline-dark mt-auto">커피</a>
        <a class="btn btn-outline-dark mt-auto">주유권</a>
        </div>
        <!-- Section-->
        <section class="py-5">
