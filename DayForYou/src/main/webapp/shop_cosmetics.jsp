    ...
    <body>
       <div align ="left" margin"10px">
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product image-->
                            <img class="card-img-top" src="./img/shop/h1.png" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">´Þ¹Ù ¹Ì½ºÆ® 100ml</h5>                                    
                                    <!-- Product price-->
                                    p)22.000
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product image-->
                            <img class="card-img-top" src="./img/shop/h2.png" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">¸Æ¸³½ºÆ½</h5>
                                    <!-- Product price-->
                                    p)33.000
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="./img/shop/h3.png" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Å°¿¤ ¼öºÐÅ©¸² 50ml</h5>                          
                                    <!-- Product price-->
                                    p)44.000
                                </div>
                            </div>
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">¹ÚÁøÅÃ ÄÄÆÛ´Ï</p></div>
        </footer>
        <!-- Bootstrap core JS-->
