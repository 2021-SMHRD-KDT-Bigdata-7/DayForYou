...
var FullCalendar = function(e) {
    ...
    function _t(e, t, n) {
        ...
        for (var r in t)
            if (!(r in e) || !xt(e[r], t[r], n[r])) return !1;
        for (var r in e)
            if (!(r in t)) return !1;
        return !0
    }
    ...
    var Ho = FullCalendarVDom.Component,
        ...
        zo = FullCalendarVDom.flushToDom,
    ...
    var qo = function(e) {
        ...
        return n(t, e), t.prototype.shouldComponentUpdate = function(e, t) {
            return this.debug && console.log(Tt(e, this.props), Tt(t, this.state)), !_t(this.props, e, this.propEquality) || !_t(this.state, t, this.stateEquality)
            ...
            case "RECEIVE_EVENTS":
                return function(e, t, n, r, o, i) {
                    if (t && n === t.latestFetchId) {
                        ...
                        return r && (a = Mt(a, r, i)), Mn(_i(e, t.sourceId), a)
                    }
                    return e
    ...
    var Li = [Jo({
        ...
        eventSourceDefs: [{
            ...
            fetch: function(e, t, n) {
                ...
                _o(e.eventSource.meta.bind(null, br(e.range, r)), (function(e) {
                    t({
                        rawEvents: e
                    })
                }), n)
    ...
    var Vi = function() {
        ...
        return e.prototype.resetOptions = function(e, t) {
            ...
            for (var f = mi(o.eventSources, e, p, c), h = wi(o.eventStore, e, f, p, c), v = yi(f) && !u.options.progressiveEventRendering && o.renderableEventStore || h, g = this.buildViewUiProps(c), m = g.eventUiSingleBase, y = g.selectionConfig, S = this.buildEventUiBySource(f), E = {
                    ...
                    dateSelection: xi(o.dateSelection, e),
        ...
        Ca = function(e) {
            function t() {
                ...
                return t.buildViewContext = $t(jo), t.buildViewPropTransformers = $t(Ra), t.buildToolbarProps = $t(Da), t.headerRef = Wo(), t.footerRef = Wo(), t.interactionsStore = {}, t.state = {
                    ...
                    delete t.interactionsStore[e.uid], delete pa[e.uid]
        ...
        Ia = function(e) {
            ...
            return n(t, e), t.prototype.render = function() {
                var e = this.props,
                    ...
                    u = [_a].concat(fo(l, o), e.extraClassNames || []),
    ...
    var Ps = function(e) {
        ...
        return n(t, e), Object.defineProperty(t.prototype, "view", {
            ...
            e.prototype.updateSize.call(this), zo()
    ...
    var Ns = 0,
        ...
        As = function() {
            function e(e) {
                ...
                }, this.containerEl = e, this.emitter = new xo, e.addEventListener("mousedown", this.handleMouseDown), e.addEventListener("touchstart", this.handleTouchStart, {
                    passive: !0
        ...
        Fs = function() {
            ...
            return e.prototype.start = function(e, t, n) {
                ...
                for (var t = [], n = 0, r = this.scrollQuery; n < r.length; n++) {
                    var o = r[n];
                    "object" == typeof o ? t.push(o) : t.push.apply(t, Array.prototype.slice.call(xe(e).querySelectorAll(o)))
                }
                return t
            }, e
        }(),
    ...
    var qs = function() {
        function e(e, t) {
            ...
            }, this.droppableStore = t, e.emitter.on("pointerdown", this.handlePointerDown), e.emitter.on("dragstart", this.handleDragStart), e.emitter.on("dragmove", this.handleDragMove), e.emitter.on("pointerup", this.handlePointerUp), e.emitter.on("dragend", this.handleDragEnd), this.dragging = e, this.emitter = new xo
        }
    ...
    var $s = function(e) {
        function t(n) {
            ...
            o.subjectEl = null, o.subjectSeg = null, o.isDragging = !1, o.eventRange = null, o.relevantEvents = null, o.receivingContext = null, o.validMutation = null, o.mutatedRelevantEvents = null, o.handlePointerDown = function(e) {
                ...
                o.relevantEvents = xn(l.getCurrentData().eventStore, c), i.minDistance = e.isTouch ? 0 : s.eventDragMinDistance, i.delay = e.isTouch && c !== r.props.eventSelection ? function(e) {
                    var t = e.context.options,
                ...
                if (o.isDragging) {
                    ...
                    if (e) {
                        ...
                        i === a || d.editable && d.droppable ? (s = function(e, t, n) {
                            ...
                            return u
                        }(r, e, a.getCurrentData().pluginHooks.eventDragMutationMassagers)) && (l = _r(n, a.getCurrentData().eventUiBases, s, a), c.mutatedEvents = l, Ba(c, e.dateProfile, a) || (u = !0, s = null, l = null, c.mutatedEvents = {
                            defs: {},
                            instances: {}
                        })) : a = null
                    }
                    o.displayDrag(a, c), u ? Ue() : Be(), t || (i === a && Ys(r, e) && (s = null), o.dragging.setMirrorNeedsRevert(!s), o.dragging.setMirrorIsVisible(!e || !xe(o.subjectEl).querySelector(".fc-event-mirror")), o.receivingContext = a, o.validMutation = s, o.mutatedRelevantEvents = l)
                }
        ...
        function t(t) {
            ...
            n.draggingSegEl = null, n.draggingSeg = null, n.eventRange = null, n.relevantEvents = null, n.validMutation = null, n.mutatedRelevantEvents = null, n.handlePointerDown = function(e) {
                ...
                var t = n.component.context,
                    r = n.eventRange;
                n.relevantEvents = xn(t.getCurrentData().eventStore, n.eventRange.instance.instanceId);
                ...
                l && (u = _r(i, o.getCurrentData().eventUiBases, l, o), d.mutatedEvents = u, Ba(d, e.dateProfile, o) || (c = !0, l = null, u = null, d.mutatedEvents = null)), u ? o.dispatch({
        ...
        nl = function() {
            function e(e, t) {
                ...
                this.receivingContext = null, this.droppableEvent = null, this.suppliedDragMeta = null, this.dragMeta = null, this.handleDragStart = function(e) {
                    ...
                    }(e.dateSpan, n.dragMeta, a), u.mutatedEvents = _n(s), (l = !Ba(u, e.dateProfile, a)) && (u.mutatedEvents = {
                        defs: {},
                        instances: {}
    ...
    var xl = function(e) {
        ...
        kl = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.slicer = new xl, t.tableRef = Wo(), t
            }
            return n(t, e), t.prototype.render = function() {
                var e = this.props,
                    t = this.context;
    ...
    }, _u.prototype.baseIconClass = "fa", _u.prototype.iconClasses = {
        close: "fa-times",
        prev: "fa-chevron-left",
        next: "fa-chevron-right",
        prevYear: "fa-angle-double-left",
        nextYear: "fa-angle-double-right"
    }, _u.prototype.rtlIconClasses = {
        prev: "fa-chevron-right",
        next: "fa-chevron-left",
        prevYear: "fa-angle-double-right",
        nextYear: "fa-angle-double-left"
    }, _u.prototype.iconOverrideOption = "bootstrapFontAwesome", _u.prototype.iconOverrideCustomButtonOption = "bootstrapFontAwesome", _u.prototype.iconOverridePrefix = "fa-";
    var xu = Jo({
            themeClasses: {
                bootstrap: _u
            }
        }),
        ku = "https://www.googleapis.com/calendar/v3/calendars";
    var Mu = Jo({
            eventSourceDefs: [{
                parseMeta: function(e) {
        ...
        Iu = "2021-11-03",
        Pu = ["GPL-My-Project-Is-Open-Source", "CC-Attribution-NonCommercial-NoDerivatives"],
        Nu = {
            position: "absolute",
            zIndex: 99999,
            bottom: "1px",
    ...
    var Hu, Ou = Jo({
            ...
            viewContainerAppends: [function(e) {
                ...
                if (!/\w+:\/\/fullcalendar\.io\/|\/examples\/[\w-]+\.html$/.test(n)) {
                    var r = function(e) {
                        if (-1 !== Pu.indexOf(e)) return "valid";
                        var t = (e || "").match(/^(\d+)-fcs-(\d+)$/);
                        if (t && 10 === t[1].length) {
                            var n = new Date(1e3 * parseInt(t[2], 10)),
                                r = new Date(ha.mockSchedulerReleaseDate || Iu);
        ...
        Au = "wheel mousewheel DomMouseScroll MozMousePixelScroll".split(" "),
        Wu = function() {
            function e(e) {
                var t = this;
                this.el = e, this.emitter = new xo, this.isScrolling = !1, this.isTouching = !1, this.isRecentlyWheeled = !1, this.isRecentlyScrolled = !1, this.wheelWaiter = new Ui(this._handleWheelWaited.bind(this)), this.scrollWaiter = new Ui(this._handleScrollWaited.bind(this)), this.handleScroll = function() {
    ...
    function Lu(e) {
        var t = e.scrollLeft;
        if ("rtl" === window.getComputedStyle(e).direction) switch (Bu()) {
            case "negative":
                t *= -1;
            case "reverse":
    ...
    var zu, Vu = "undefined" != typeof navigator && /Edge/.test(navigator.userAgent),
        Fu = function() {
            function e(e, t) {
                var n = this;
                this.scrollEl = e, this.isRtl = t, this.usingRelative = null, this.updateSize = function() {
                    ...
                    return zu
                }() || Vu && t, this.usingRelative && (this.listener = new Wu(e), this.listener.emitter.on("scrollEnd", this.updateSize))
            }
            return e.prototype.destroy = function() {
                ...
                for (var t = this.scrollEl, n = this.isRtl, r = function(e) {
                        var t = e.getBoundingClientRect(),
                            n = Do(e);
                        return {
                            left: t.left + n.borderLeft + n.scrollbarLeft - Lu(e),
    ...
    var Gu = function(e) {
        ...
        qu = function(e) {
            ...
            return n(t, e), t.prototype.render = function() {
                ...
                for (var e = new Map, t = this.getDims(), n = t[0], r = t[1], o = [], i = 0; i < n; i += 1) {
                    ...
                    if (a && a.syncRowHeights) {
                        ...
                        if (h) {
                            ...
                            for (var y = [], u = 0; u < r; u += 1) y.push(Yu(l[u]) + l[u].length);
                ...
                this.stickyScrollings.forEach(rc)
                ...
                Ct(this.scrollSyncersBySection, tc), Ct(this.scrollSyncersByColumn, tc)
    ...
    function Zu(e) {
        var t = Ce(e, ".fc-scrollgrid-sync-inner").map(Xu);
    ...
    var ic = [],
        ...
        sc = Jo({
            ...
            contextInit: function(e) {
                ic.length || (window.addEventListener("beforeprint", lc), window.addEventListener("afterprint", uc)), ic.push(e), e.calendarApi.on("_unmount", (function() {
                    Xt(ic, e), ic.length || (window.removeEventListener("beforeprint", lc), window.removeEventListener("afterprint", uc))
                }))
            }
        });
    ...
    function uc() {
        for (var e = 0, t = ic; e < t.length; e++) {
            t[e].emitter.trigger("_afterprint")
        }
        for (zo(); ac.length;) ac.shift()()
    }
    ...
    function fc(e, t, n, r) {
        ...
        ! function(e, t, n) {
            ...
            function(e, t, n) {
                var r = t.currentRange,
                    o = e.slotDuration;
                if (!o) {
                    for (var i = gc(e, t, n), a = 0, s = pc; a < s.length; a++) {
                        var l = Ht(s[a]),
                            u = Ft(i, l);
                        if (null !== u && u > 1 && u <= 6) {
                            o = l;
        ...
        o.largeUnit = s, o.emphasizeWeeks = 1 === At(o.slotDuration) && mc("weeks", e, t) >= 2 && !n.businessHours;
        ...
        var p = Vt(e.slotMaxTime) - Vt(e.slotMinTime),
            f = hc(e.renderRange.start, o, t),
            h = hc(e.renderRange.end, o, t);
        o.isTimeScale && (f = t.add(f, e.slotMinTime), h = t.add(nt(h, -1), e.slotMaxTime)), o.timeWindowMs = p, o.normalizedRange = {
            start: f,
            end: h
        };
        for (var v = [], g = f; g < h;) vc(g, o, e, r) && v.push(g), g = t.add(g, o.slotDuration);
        o.slotDates = v;
        var m = -1,
            y = 0,
            S = [],
            E = [];
        for (g = f; g < h;) vc(g, o, e, r) ? (m += 1, S.push(m), E.push(y)) : S.push(m + .5), g = t.add(g, o.snapDuration), y += 1;
    ...
    var Cc = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.refineHookProps = Jt(bc), t.normalizeClassNames = si(), t.buildCellNavLinkAttrs = $t(Dc), t
        }
        return n(t, e), t.prototype.render = function() {
            var e = this,
                t = this.props,
    ...
    var Rc = function(e) {
        ...
        wc = function() {
            ...
            return e.prototype.isDateInRange = function(e) {
                ...
                return Tc(e, this.tDateProfile, this.dateEnv)
            }, e
        }();
    ...
    var kc = function(e) {
            ...
            return n(t, e), t.prototype.render = function() {
                ...
                return Oo(Pa, {
                    ...
                    return Oo("div", {
                    ...
                    }, t.tableColGroupNode, Oo("tbody", null, Oo(Rc, {
                        dateProfile: t.dateProfile,
                        ...
                        return Oo("div", {
                            ...
                            style: _c(o.dateToCoord(r), n.isRtl)
                        }, a)
                    }))))
                }))
            }, t.prototype.componentDidMount = function() {
        ...
        Pc = function(e) {
            ...
            return n(t, e), t.prototype.render = function() {
                ...
                var e, t = this.props,
                    n = this.context;
                null !== t.clientWidth && this.scrollResponder && (this.rootElRef.current.offsetWidth && (this.coords = new wc(this.rootElRef.current, (e = this.cellElRefs.currentMap, t.tDateProfile.slotDates.map((function(t) {
                    var n = t.toISOString();
                    return e[n]
    ...
    var Hc = function(e) {
        ...
        Oc = function(e) {
            ...
            return n(t, e), t.prototype.sliceRange = function(e, t, n, r, o) {
                var i = function(e, t, n) {
                    ...
                    a = [];
                if (Tc(i.start, r, o) < Tc(i.end, r, o)) {
                    var s = $n(i, r.normalizedRange);
                    s && a.push({
                        start: s.start,
                        end: s.end,
                        isStart: s.start.valueOf() === i.start.valueOf() && vc(s.start, r, t, n),
                        isEnd: s.end.valueOf() === i.end.valueOf() && vc(rt(s.end, -1), r, t, n)
                    })
                }
                return a
            }, t
        ...
        Uc = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.slicer = new Oc, t.sortEventSegs = $t(lr), t.harnessElRefs = new Ka, t.moreElRefs = new Ka, t.innerElRef = Wo(), t.state = {
                    eventInstanceHeights: {},
                    moreLinkHeights: {}
                }, t
            }
            return n(t, e), t.prototype.render = function() {
                var e = this,
                    ...
                    }(u, Nc(u, o.eventMinWidth, t.timelineCoords), n.eventInstanceHeights, n.moreLinkHeights, o.eventOrderStrict, o.eventMaxStack),
                    d = c[0],
                    p = c[1],
    ...
    var Bc = function(e) {
                ...
                return Oo("div", {
                    ...
                    return Oo(Lo, null, Oo(Pc, {
                        ...
                        return Oo("div", {
                            ...
                            style: _c(r.coords.dateToCoord(t), o.isRtl)
                        }, a)
                    }))))
                })))
        ...
        zc = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.buildTimelineDateProfile = $t(fc), t.scrollGridRef = Wo(), t.state = {
                    slatCoords: null,
            ...
            return n(t, e), t.prototype.render = function() {
                var e = this,
                    ...
                    d = a.slotMinWidth,
                    p = Vc(u, d || this.computeFallbackSlotMinWidth(u)),
                    f = [{
                        type: "header",
                        key: "header",
                        isSticky: s,
    ...
    var Yc = function() {
        function e() {
            this.buildResourceEventUis = $t(Zc, wt), this.injectResourceEventUis = $t(Xc)
        }
        return e.prototype.transform = function(e, t) {
    ...
    function td(e) {
        ...
        if ("string" == typeof e ? t = {
            ...
            var o = function(e) {
                for (var t = Qc(), n = t.length - 1; n >= 0; n -= 1) {
    ...
    function nd(e, t, n) {
        var o = n.options,
            i = n.dateProfile;
        if (!e || !t) return rd(o.initialResources || o.resources, i.activeRange, o.refetchResourcesOnNavigate, n);
        switch (t.type) {
            case "RESET_RESOURCE_SOURCE":
                return rd(t.resourceSourceInput, i.activeRange, o.refetchResourcesOnNavigate, n);
            case "PREV":
            case "NEXT":
            case "CHANGE_DATE":
            case "CHANGE_VIEW_TYPE":
                return function(e, t, n, r) {
                    if (n && ! function(e) {
                            return Boolean(Jc(e.sourceDefId).ignoreRange)
                        }(e) && (!e.fetchRange || !Jn(e.fetchRange, t))) return od(e, t, r);
                    return e
    ...
    function rd(e, t, n, r) {
        if (e) {
            var o = td(e);
            return o = od(o, n ? t : null, r)
        }
        return null
    }

    function od(e, t, n) {
        var o = Jc(e.sourceDefId),
            i = Le();
        return o.fetch({
            resourceSource: e,
            range: t,
    ...
    Or.prototype.addResource = function(e, t) {
        ...
        e instanceof dd ? ((n = {})[(i = e._resource).id] = i, o = n) : i = sd(e, "", o = {}, a), this.dispatch({
            type: "ADD_RESOURCE",
            resourceHash: o
        }), t && this.trigger("_scrollRequest", {
            resourceId: i.id
        ...
        var e = this.getCurrentData(),
            ...
            n = [];
        if (t)
            for (var r in t) n.push(new dd(e, t[r]));
        return n
        ...
        var e = this.getCurrentData(),
            ...
            n = [];
        if (t)
            for (var r in t) t[r].parentId || n.push(new dd(e, t[r]));
        return n
    ...
    function fd(e, t) {
        return r(r({}, t), {
            constraints: hd(e, t.constraints)
        })
    }
    ...
    Ar.prototype.getResources = function() {
        ...
        for (var t = [], n = 0, r = e; n < r.length; n++) {
            var o = r[n],
                i = null;
            "string" == typeof o ? i = o : "number" == typeof o ? i = String(o) : o instanceof dd ? i = o.id : console.warn("unknown resource type: " + o), i && t.push(i)
        }
        this.mutate({
            standardProps: {
                resourceIds: t
    ...
    var bd = function(e) {
        ...
        Cd = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.buildDateFormat = $t(Dd), t
            }
            return n(t, e), t.prototype.render = function() {
                var e = this,
                    t = this.props,
                ...
                var a = this.props,
                    s = o ? ":" + o.id : "",
                    l = o ? {
                        resource: new dd(this.context, o)
                    } : {},
                    u = o ? {
    ...
    var Rd = function(e) {
        ...
        wd = function() {
            function e(e, t, n) {
                this.dayTableModel = e, this.resources = t, this.context = n, this.resourceIndex = new Rd(t), this.rowCnt = e.rowCnt, this.colCnt = e.colCnt * t.length, this.cells = this.buildCells()
            }
            return e.prototype.buildCells = function() {
                for (var e = this, t = e.rowCnt, n = e.dayTableModel, r = e.resources, o = [], i = 0; i < t; i += 1) {
                    for (var a = [], s = 0; s < n.colCnt; s += 1)
                        for (var l = 0; l < r.length; l += 1) {
                            var u = r[l],
                                c = {
                                    resource: new dd(this.context, u)
                                },
                                d = {
        ...
        kd = function() {
            ...
            return e.prototype.joinProps = function(e, t) {
                for (var n = [], r = [], i = [], a = [], s = [], l = [], u = "", c = 0, d = t.resourceIndex.ids.concat([""]); c < d.length; c++) {
                    var p = d[c],
                        f = e[p];
                    n.push(f.dateSelectionSegs), r.push(p ? f.businessHourSegs : xd), i.push(p ? f.fgEventSegs : xd), a.push(f.bgEventSegs), s.push(f.eventDrag), l.push(f.eventResize), u = u || f.eventSelection
                }
                return {
    ...
    function Id(e, t) {
        return Pd(e, [], t, !1, {}, !0).map((function(e) {
            return e.resource
        }))
    }
    ...
    function Pd(e, t, n, r, o, i) {
        ...
        return Nd(function(e, t, n, r) {
            ...
            for (var a in o) {
                var s = o[a];
                s.resource.parentId || Hd(s, i, n, 0, t, r)
            }
            return i
        }(e, r ? -1 : 1, t, n), a, r, [], 0, o, i), a
    }

    function Nd(e, t, n, r, o, i, a) {
        for (var s = 0; s < e.length; s += 1) {
            ...
            if (u)
                if (n) {
                    var c = t.length,
                        d = r.length;
                    if (Nd(l.children, t, n, r.concat(0), o, i, a), c < t.length) {
                        var p = t[c];
    ...
    function Hd(e, t, n, r, o, i) {
        n.length && (-1 === o || r <= o) ? Hd(e, function(e, t, n) {
            ...
            return r
        }(e, t, n[0]).children, n.slice(1), r + 1, o, i) : Od(e, t, i)
    }
    ...
    var Ld = Jo({
            ...
            reducers: [function(e, t, n) {
                var o = nd(e && e.resourceSource, t, n);
                return {
                    resourceSource: o,
                    resourceStore: ud(e && e.resourceStore, t, o, n),
            ...
            isDraggableTransformers: [function(e, t, n, r) {
                if (!e) {
                    ...
                    if (o.viewSpecs[o.currentViewType].optionDefaults.needsResourceData && Gc(t, r)) return !0
                }
                return e
            }],
            ...
            viewPropsTransformers: [jc, Yc],
            isPropsValid: function(e, t) {
                var n = (new pd).splitProps(r(r({}, e), {
            ...
            propSetHandlers: {
                resourceStore: function(e, t) {
                    ...
                    n.hasHandlers("resourcesSet") && n.trigger("resourcesSet", function(e, t) {
                        var n = [];
                        for (var r in e) n.push(new dd(t, e[r]));
                        return n
                    }(e, t))
                }
            }
        ...
        Bd = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.splitter = new Md, t.slicers = {}, t.joiner = new Ud, t.tableRef = Wo(), t.isHitComboAllowed = function(e, n) {
        ...
        zd = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.flattenResources = $t(Id), t.buildResourceDayTableModel = $t(Vd), t.headerRef = Wo(), t.tableRef = Wo(), t
            }
            return n(t, e), t.prototype.render = function() {
                var e = this,
                    t = this.props,
    ...
    function Vd(e, t, n, r, o) {
        var i = Il(e, t);
        return r ? new _d(i, n, o) : new Td(i, n, o)
    }
    var Fd = Jo({
            deps: [Ou, Ld, Pl],
        ...
        jd = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.buildDayRanges = $t(du), t.splitter = new Md, t.slicers = {}, t.joiner = new Gd, t.timeColsRef = Wo(), t.isHitComboAllowed = function(e, n) {
        ...
        qd = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.flattenResources = $t(Id), t.buildResourceTimeColsModel = $t(Yd), t.buildSlatMetas = $t(fu), t
            }
            return n(t, e), t.prototype.render = function() {
                var e = this,
                    t = this.props,
    ...
    function Kd(e) {
        return {
            resource: new dd(e.context, e.resource),
    ...
    var Qd = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.refineHookProps = Jt(Kd), t.normalizeClassNames = si(), t.onExpanderClick = function(e) {
                    var n = t.props;
    ...
    var np = function(e) {
        ...
        return n(t, e), t.prototype.render = function() {
            ...
            return Oo("tr", {
                ...
                if (0 === s) return null;
                null == s && (s = 1);
                var l = i.field ? o[i.field] : t.title || ld(t.id);
                return s > 1 ? Oo(ep, {
                    key: a,
                    colSpec: i,
                    fieldValue: l,
    ...
    var ip = function(e) {
        ...
        sp = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.refineHookProps = Jt(lp), t.normalizeClassNames = si(), t.handleHeightChange = function(e, n) {
    ...
    var pp = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.computeHasResourceBusinessHours = $t(fp), t.resourceSplitter = new pd, t.bgSlicer = new Oc, t.slatsRef = Wo(), t.state = {
                slatCoords: null
            }, t.handleEl = function(e) {
                e ? t.context.registerInteractiveComponent(t, {
                    el: e
            ...
            return Oo("div", {
                ...
                return Oo(Lo, null, Oo(Pc, {
                    ...
                    return Oo("div", {
                        ref: e,
                        className: ["fc-timeline-now-indicator-line"].concat(n).join(" "),
                        style: _c(p.dateToCoord(t), o.isRtl)
                    }, i)
                }))))
            })))
        }, t.prototype.queryHit = function(e, t) {
    ...
    var hp = function(e) {
        ...
        vp = function(e) {
            function t(t, n) {
                var r = e.call(this, t, n) || this;
                return r.processColOptions = $t(Sp), r.buildTimelineDateProfile = $t(fc), r.hasNesting = $t(yp), r.buildRowNodes = $t(Pd), r.layoutRef = Wo(), r.rowNodes = [], r.renderedRowNodes = [], r.buildRowIndex = $t(gp), r.handleSlatCoords = function(e) {
                    r.setState({
                        slatCoords: e
                    })
            ...
            return n(t, e), t.prototype.render = function() {
                var e = this,
                    ...
                    g = i.slotMinWidth,
                    m = Vc(f, g || this.computeFallbackSlotMinWidth(f));
                return Oo(ci, {
                    viewSpec: a
                }, (function(t, i) {
                    return Oo("div", {
                        ...
                        spreadsheetCols: mp(p, r.spreadsheetColWidths, ""),
    ...
    function Sp(e) {
        ...
        for (var f = [], h = 0, v = e.resourceOrder || gd; h < v.length; h++) {
