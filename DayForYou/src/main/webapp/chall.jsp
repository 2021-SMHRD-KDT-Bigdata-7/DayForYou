...
<body>
   ...
   //year=cal.add(Calendar.YEAR, 1); //1년 더하기 
   //month=cal.add(Calendar.MONTH, -3); //3개월 빼기
   //day=cal.add(Calendar.DATE, 2); //2일 더하기
   //hour=cal.add(Calendar.HOUR_OF_DAY, -2); //2시간빼기
   //min=cal.add(Calendar.MINUTE, 20); //20분 더하기
   //sec=cal.add(Calendar.SECOND, -10); //10초 빼기
   //System.out.println(year + "년도 " + month + "월 " + day + "일 " + hour + "시 " + min + "분 " + sec + "초");
         ...
         <ul>
            <li><span class="radio" id="all_list"> <input
                  ...
                  checked=""> <label for="view_all2"><span
                     class="round"></span>12월 13일(sysdate) (월)</label>
            </span></li>
            <li><span class="radio" id="lend_list"> <input
