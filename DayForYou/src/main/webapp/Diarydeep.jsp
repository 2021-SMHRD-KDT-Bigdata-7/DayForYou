...
>>>>>>> branch 'master' of https://github.com/2021-SMHRD-KDT-Bigdata-7/DayForYou.git
							...
							<div style = "padding: 0px">
								...
								<input type = "button" value = "목록" ></a> -->							
									...
									<button onclick = "location.href='Diarylist.jsp'" style="width: 50px; height:30px; background-color:gray; font-size: 12px; border: none; position: relative; left: 240px; color: white;">목록</button>	
									<a href = "diaryDelete?diary_seq=<%=dvo.getDiary_seq()%>" style="position:relative; right: 50px;">삭제<img src = "img/delete.PNG" style="width: 30px; height:30px;"></a>
